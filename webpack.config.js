...
module.exports = {
    ...
    devServer: {
        static: {
            // ИСПРАВЛЕНИЕ: Webpack создает index.html с тегом <script src="app.js">
            // именно в папке dist. Сервер должен раздавать файлы оттуда.
            directory: path.join(__dirname, "dist"),
        },
        compress: true,
        port: 9000,
        historyApiFallback: true, // Для роутинга без #
    },
    ...
    module: {
        rules: [
            {
                test: /\.scss$/i, // Исправлен regex (добавлен слэш)
                use: [
                    "style-loader",
                    "css-loader",
                    "sass-loader",
